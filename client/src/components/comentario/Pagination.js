...
const Pagination = ({pages, setCurrentPage, currentComentario, sortedComentario}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentComentario.length}</b> out of <b>{sortedComentario.length}</b> entries</div>
