...
const Pagination = ({pages, setCurrentPage, currentCondiciones, sortedCondiciones}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentCondiciones.length}</b> out of <b>{sortedCondiciones.length}</b> entries</div>
