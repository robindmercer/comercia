...
function ABMTicket() {
   ...
   const grabar = () => {
      ...
      if (state.tck_linea > 1 ){
         input.nuevotck   = input.conclusion 
         input.conclusion = ""
      } else  {
         input.nuevotck   = input.description 
      }
            ...
            placeholder="Lugar"></input> */}
               ...
               <p className="c23">
                  ...
                  <input
                     onClick={() => marcar("A")}
                     className={
                        "xinput " + (chkA === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkA"
                     value={chkA}
                  ...
                  <input
                     onClick={() => marcar("B")}
                     className={
                        "xinput " + (chkB === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkB"
                     value={chkB}
                  ...
                  <input
                     onClick={() => marcar("C")}
                     className={
                        "xinput " + (chkC === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id={chkC}
                     value={chkC}
               ...
               <p className="c23">
                  ...
                  <input
                     onClick={() => marcar("D")}
                     className={
                        "xinput " + (chkD === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkD"
                     value={chkD}
                  ...
                  <input
                     onClick={() => marcar("E")}
                     className={
                        "xinput " + (chkE === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkE"
                     value={chkE}
                  ...
                  <input
                     onClick={() => marcar("F")}
                     className={
                        "xinput " + (chkF === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkF"
                     value={chkF}
               ...
               <p className="c23">
                  ...
                  <input
                     onClick={() => marcar("G")}
                     className={
                        "xinput " + (chkG === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkG"
                     value={chkG}
                  ...
                  <input
                     onClick={() => marcar("H")}
                     className={
                        "xinput " + (chkH === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkH"
                     value={chkH}
                  ...
                  <input
                     onClick={() => marcar("I")}
                     className={
                        "xinput " + (chkI === "X" ? "textok" : "textnormal")
                     }
                     type="text"
                     id="chkI"
                     value={chkI}
               ...
               <ol className="c36 lst-kix_list_1-0" start="7">
                  <li className="c10 li-bullet-0">
                     <span className="c8">Datos del Nuevo Ticket</span>
                  </li>
               </ol>
               ) : (
               <ol className="c36 lst-kix_list_1-0" start="7">
