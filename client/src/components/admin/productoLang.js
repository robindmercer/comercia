    ...
    <br/>
     ...
     <thead>
         <tr>
             ...
             <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Lenguaje</th>
         ...
         {productoLang && productoLang.map(prod => { 
             return (
                 <tr key={prod.id} >
                     ...
                     <td className="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{prod.lang}</td>
                     <td className="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{prod.name}</td>
