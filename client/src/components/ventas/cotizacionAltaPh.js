   ...
   if (mostrar && factcab.length > 0) {
      ...
      return (
         <>
            <Header />
            <div>
               <div className="cabeceraAltaPh">
                        <div className="col">Fecha: {fecha}</div>
                     <div>
                        <label className="lblwdth" htmlFor="nombre">Nombre : </label>
                        <input
                     ...
                     <div>                        
                        <label className="lblwdth" htmlFor="direccion">Direccion : </label>
                        <input
                           className="input_text"
                           type="text"
                           id="direccion"
                     ...
                     <div>                        
                        <label className="lblwdth" htmlFor="telefono">Telefono : </label>
                        <input
                           className="input_text"
                           type="text"
                           id="telefono"
                     ...
                     <div>
                        <label className="lblwdth" htmlFor="email">Email : </label>
                        <input
                     ...
                     <div>                        
                        <label className="lblwdth" htmlFor="vencimiento">Vencimiento&nbsp;</label>
                        <input
                           id="vencimiento"
                           name="vencimiento"
                           type="date"
                     ...
                     <div>
                        <label 
                           htmlFor="tipocli"
                           className="block text-gray-700 text-sm font-bold mb-2 lblwdth"
                        >
                           Moneda:
                        </label>
                        <select
