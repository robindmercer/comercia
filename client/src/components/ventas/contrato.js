...
function Contrato() {
   ...
   const getTextoArrendamiento = () => {
      textoIni =
         "Contrato entre <strong>NIBBOT INTERNATIONAL</strong> y @nombre con fecha @fecha<br/>";
      textoIni +=
         "Mediante la presente se deja constancia del contrato de Arrendamiento celebrado entre las partes:<br/>";
      textoIni += "La empresa que ofrece el servicio / producto:<br/>";
      textoIni +=
         "<strong>NIBBOT INTERNATIONAL</strong> con RFC NIN180922KJ2, debidamente constituida con domicilio fiscal en Dr.  Gabriel Martínez No 14 - Colonia Centro, S.L.P. - 79610, considerado a partir de ahora la empresa y,<br/>";
      textoIni += "Especialista médico, Comprador, Arrendador:<br/>";
      textoIni +=
         "<strong>@nombre</strong> con domicilio particular establecido en Calle @dircomp, CLAVE DE ELECTOR @claveelec considerado a partir de ahora el Arrendador, con fecha @fecha.<br/>";
      textoIni +=
         "<br/>En donde se establece la Renta del Equipo PROFESSIONAL NIBBOT, a un precio establecido de @moneda @importe (<strong>@impLetras</strong> @monletra).<br/>";
      textoIni +=
         "<br/>Datos del producto:<br/>Nombre del producto: @producto<br/>No. Serie: @serie<br/>Garantía: @garantia<br/>";
      txtAdicional = "<br/>@adicional<br/><br/>";
      clausulas =
         "                                                           <strong>C L Á U S U L A S</strong><br/><br/>";
      ...
      clausulas +=
         "La empresa garantiza el correcto funcionamiento, calibración y los más altos estándares de calidad de la unidad y accesorios que el comprador va a recibir en el plazo mencionado en el apartado anterior<br/><br/>";
      clausulas +=
         "La empresa no se hace responsable y no entra en garantía si el equipo tuvo mal uso, fue negligencia del comprador, o no siguió las indicaciones correspondientes dadas en su capacitación.<br/><br/>";
      clausulas +=
         "La empresa pone a disposición el contacto directo de nuestro departamento:<br/>";
      clausulas += "     Atención a clientes:  info@nibbot.com.mx<br/><br/>";
      clausulas += "<strong>Arrendador</strong><br/><br/><br/>";
      clausulas +=
         "El Arrendador se compromete a dar buen uso del equipo adquirido.<br/><br/>";
      clausulas +=
         "El Arrendador declara que conoce y está interesado en adquirir el producto en el estado físico que se encuentra y que tiene la capacidad para hacer frente a sus obligaciones establecidas en el presente Contrato, así como el cumplimiento de pago total o parcial del equipo adquirido.<br/><br/>";
      clausulas +=
         "El Arrendador se da por enterado que, en caso de existir mora de más de 30 días a partir de la fecha de pago vencida, la empresa tiene la libertad de efectuar el corte de servicio vía remota, generando un cargo de reconexión de @moneda @punitorio (<strong>@punitLetras</strong> @monletra), hasta que el saldo de mora sea cubierto.<br/><br/>";
      clausulas +=
   ...
   const getTextoContrato = () => {
      textoIni =
         "Contrato entre <strong>NIBBOT INTERNATIONAL</strong> y @nombre con fecha @fecha<br/>";
      textoIni +=
         "Mediante la presente se deja constancia del Contrato de venta celebrado entre las partes:<br/>";
      textoIni += "La empresa que ofrece el servicio / producto:<br/>";
      textoIni +=
         "<strong>NIBBOT INTERNATIONAL</strong> con RFC <strong>NIN180922KJ2</strong>, debidamente constituida con domicilio fiscal en Dr.  Gabriel Martínez No 14 - Colonia Centro, S.L.P. - 79610, considerado a partir de ahora la empresa y<br/>";
      textoIni += "Especialista médico, Comprador:<br/>";
      textoIni +=
         "@nombre con RFC @rfc y domicilio particular establecido en @dircomp,";
      textoIni +=
         "Clave de Elector @claveelec y No. DE Cédula profesional @cedula considerado a partir de ahora el comprador, con fecha @fecha.<br/><br/>";
      textoIni +=
         "En donde se establece la compra de los productos detallado a continuación según la Cotización CT-@coti, a un precio establecido de @moneda @importe (<strong>@impLetras</strong> @monletra).<br/>";
      textoIni +=
         "<br/>Datos del producto:<br/>Nombre del producto: @producto<br/>No. Serie: @serie<br/>Garantía: @garantia<br/>";
      txtAdicional = "<br/>@adicional<br/><br/>";
      clausulas =
      ...
      clausulas += "<strong>La empresa</strong><br/><br/>";
      clausulas +=
         "La empresa se compromete a hacer entrega de la unidad y accesorios en un plazo no mayor a los 45 días de confirmado el primer pago correspondiente al plan aprobado de financiamiento, o al pago total del equipo. La modalidad de entrega será vía correo DHL servicio postal.<br/><br/>";
      clausulas +=
         "La empresa garantiza el correcto funcionamiento, calibración y los más altos estándares de calidad de la unidad y accesorios que el comprador va a recibir en el plazo mencionado en el apartado anterior.<br/><br/>";
      clausulas +=
         "La empresa se compromete a poner a disposición del comprador las herramientas de capacitación, material bibliográfico, tutoría profesional y asistencia técnica para promover la debida certificación profesional en el curso de capacitación en Estimulación Magnética Transcraneal.<br/><br/>";
      clausulas +=
         "La empresa se compromete a hacer válida la garantía de buen funcionamiento correspondiente al producto comprado descrito en la cotización mencionada en el presente contrato, de la unidad principal y accesorios, ofreciendo cobertura total para el comprador (Solo si es defecto de ensamble)<br/><br/>";
      clausulas +=
         "La empresa no se hace responsable y no entra en garantía si el equipo tuvo mal uso, fue negligencia del comprador, o no siguió las indicaciones correspondientes dadas en su capacitación, así como en el manual de usuario.<br/><br/>";
      clausulas +=
         "La empresa pone a disposición del comprador, base de datos profesional de consulta bibliográfica, comunidad profesional equipada con TMS, Soporte Técnico, Asesoría profesional y área de Investigación y Nuevos Proyectos.<br/><br/>";
      clausulas +=
         "La empresa pone a disposición el contacto directo de nuestro departamento:<br/>";
      clausulas += "   # Atención a clientes:  info@nibbot.com.mx<br/><br/>";
      clausulas +=
         "La empresa emitirá la facturación en modalidad de gastos en general en cada pago realizado por el cliente, esto únicamente aplicable cuando el financiamiento sea mayor a 6 meses. O cuando el cliente lo requiera.<br/>";
      clausulas += "<br/>";
      clausulas += "<strong>Especialista Médico</strong><br/><br/>";
      clausulas +=
         "El comprador se compromete a dar buen uso del equipo adquirido siguiendo el manual de usuario.<br/>";
      clausulas +=
         "El comprador garantiza el cumplimiento de los términos y condiciones en su garantía.<br/>";
      clausulas +=
         "El comprador declara que conoce y está interesado en adquirir el producto en el estado físico que se encuentra y que tiene la capacidad para hacer frente a sus obligaciones establecidas en el presente Contrato, así como el cumplimiento de pago total o parcial del equipo adquirido.<br/>";
      clausulas +=
         "El comprador se da por enterado que, en caso de existir mora de más de 30 días a partir de la fecha de pago vencida, la empresa tiene la libertad de efectuar el corte de servicio vía remota, generando un cargo de reconexión de $2,500.00 (dos mil quinientos pesos) mexicanos, hasta que el saldo de mora sea cubierto.<br/>";
      clausulas +=
         "El comprador se da por enterado que, en caso de existir una mora por más de 90 días, la empresa puede cancelar el servicio vía remota y solicitar la devolución de la unidad, debiéndose pagar un cargo por cancelación del contrato, equivalente a un 40% del valor de la orden de compra, menos el importe abonado hasta la fecha de cancelación.<br/>";
      clausulas += "<br/>";
   ...
   if (factcab.length > 0) {
      ...
      input.nombre  = factcab[0].nombre
      input.dircomp = factcab[0].calle + " " + factcab[0].ciudad 
      input.importe = factcab[0].total 
   }
   const cambiarTexto = () => {
      ...
      if (input.moneda !== "") {
         ...
         textoIni = textoIni.replace(
            "@importe",
            "<strong>" +
               Intl.NumberFormat("de-DE").format(input.importe) +
               "</strong>"
         );
         textoIni = textoIni.replace(
            "@impLetras",
      ...
      if (input.punitorio !== "") {
         clausulas = clausulas.replace(
            "@punitorio",
            "<strong>" +
               Intl.NumberFormat("de-DE").format(input.punitorio) +
               "</strong>"
         );
         clausulas = clausulas.replace(
            "@punitLetras",
      ...
      if (input.moneda === "$") {
         ...
         clausulas = clausulas.replace("@monletra", "<strong>Dolares</strong>");
      }
      ...
      datosAdic = datosAdic.replaceAll(
         '<b style="color: var(--bs-body-color); font-size: var(--bs-body-font-size);"',
         "<b"
      );
      datosAdic = datosAdic.replaceAll(
         '<span style="color: var(--bs-body-color); font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight);',
         ""
      );
         ...
         <>
            ...
            <div className={style.docum}>
               ...
               <div className={style.cuerpo}>
                  ...
                  <button className="nibbotBtn" onClick={() => crearContrato()}>
                     Ver Contrato
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button className="nibbotBtn" onClick={() => arrendamiento()}>
                     Arrendamiento
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button className="nibbotBtn" onClick={() => generarPdf()}>
                     Generar PDF
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button
